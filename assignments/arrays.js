...
let lastCar = 0;
console.log(`${inventory[inventory.length-1].car_make} ${inventory[inventory.length-1].car_year} ${inventory[inventory.length-1].car_model}`);
...
console.log(`========================Car Year and Model ======================================================`)
...
console.log(oldCars + '\n' + 'number of old cars: ' + oldCars.length);
